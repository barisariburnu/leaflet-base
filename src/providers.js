(function(factory) {
    ...
    providers['OpenStreetMap_Mapnik'] = {
        title: 'osm',
        icon: './src/images/openstreetmap_mapnik.png',
    ...
    providers['OpenStreetMap_BlackAndWhite'] = {
        title: 'osm bw',
        icon: './src/images/openstreetmap_blackandwhite.png',
    ...
    providers['OpenStreetMap_DE'] = {
        title: 'osm de',
        icon: './src/images/openstreetmap_de.png',
    ...
    providers['Stamen_Toner'] = {
        title: 'toner',
        icon: './src/images/stamen_toner.png',
    ...
    providers['Esri_OceanBasemap'] = {
        title: 'esri ocean',
        icon: './src/images/esri_oceanbasemap.png',
    ...
    providers['HERE_normalDay'] = {
        title: 'normalday',
        icon: './src/images/here_normalday.png',
    ...
    providers['HERE_normalDayGrey'] = {
        ...
        icon: './src/images/here_normaldaygrey.png',
    ...
    providers['HERE_satelliteDay'] = {
        title: 'satellite',
        icon: './src/images/here_satelliteday.png',
    ...
    providers['CartoDB_Positron'] = {
        title: 'positron',
        icon: './src/images/cartodb_positron.png',
